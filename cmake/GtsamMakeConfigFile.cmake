...
function(GtsamMakeConfigFile PACKAGE_NAME)
	...
	set(DEF_INSTALL_CMAKE_DIR lib/cmake/${PACKAGE_NAME_LOWER})
	...
	configure_file(${GTSAM_CONFIG_TEMPLATE_PATH}/Config.cmake.in "${PROJECT_BINARY_DIR}/${PACKAGE_NAME_LOWER}-config.cmake" @ONLY)
	message(STATUS "Wrote ${PROJECT_BINARY_DIR}/${PACKAGE_NAME_LOWER}-config.cmake")
	...
	#install(EXPORT ${PACKAGE_NAME}-exports NAMESPACE ${PACKAGE_NAME_LOWER}:: DESTINATION ${DEF_INSTALL_CMAKE_DIR})
